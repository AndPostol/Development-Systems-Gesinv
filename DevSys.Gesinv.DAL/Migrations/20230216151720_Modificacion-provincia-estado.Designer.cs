...
namespace DevSys.Gesinv.DAL.Migrations
{
    ...
    [Migration("20230216151720_Modificacion-provincia-estado")]
    partial class Modificacionprovinciaestado
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevSys.Gesinv.Models.Requisicion", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("RequisicionId"), 1L, 1);

                    b.Property<string>("CodigoRequisicion")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DevSys.Gesinv.Models.Requisicion", b =>
                {
                    b.HasOne("DevSys.Gesinv.Models.Departamento", "OrdenCompra")
                        .WithMany("Requisicion")
                        .HasForeignKey("OrdenCompraId");
            ...
            modelBuilder.Entity("DevSys.Gesinv.Models.Salida", b =>
                {
                    ...
                    b.HasOne("DevSys.Gesinv.Models.Requisicion", "Requisicion")
                        .WithMany("Salida")
