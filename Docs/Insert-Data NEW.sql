...
VALUES
  (1,'Vendas',3,6,100,10,3,'0','1','0','libero lacus, varius et, euismod','09-22-23',200, 1, 2),
  (2,'Gasas',3,3,100,10,3,'0','0','0','tempor diam dictum sapien.','09-02-23',200, 2, 3),
  (3,'Alcohol',4,5,100,10,4,'1','0','0','vitae dolor. Donec fringilla. Donec feugiat metus sit amet','02-10-23',200, 3, 4),
  (4,'Inyectadora',1,3,100,10,2,'0','1','1','mauris. Suspendisse aliquet molestie tellus. Aenean egestas hendrerit','12-29-22',200, 4, 5),
  (5,'Guantes',3,2,100,10,3,'1','0','0','dolor dapibus gravida. Aliquam tincidunt,','04-23-22',200, 5, 6),
  (6,'Par Muletas',1,3,100,10,2,'1','0','1','Nulla eget metus eu erat','04-13-23',200, 6, 7),
  (7,'Acetaminofen',3,3,100,10,2,'1','0','0','non, dapibus rutrum, justo. Praesent luctus. Curabitur','12-17-23',200, 7, 8),
  (8,'Yeso',3,6,100,10,2,'1','0','0','a purus.','07-12-22',200, 8, 1),
  (9,'Ibuprofeno',4,2,100,10,4,'1','1','0','lorem ipsum sodales purus, in molestie tortor nibh sit amet','01-03-23',200, 9, 2),
  (10,'Pack Paletas',2,5,100,10,2,'0','1','1','id, erat. Etiam vestibulum massa rutrum magna. Cras','05-15-22',200, 10, 3);
